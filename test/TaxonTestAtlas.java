...
public class TaxonTestAtlas extends WithApplication 
{
	...
	private static final String URI_TAXON_194412_GEOJSON = API + "/taxon/194412/geojson";
	
	private static final String URI_TAXON_1_INFO = API + "/taxon/1/informations";
	
	private static final String URI_TAXON_194412_INFO = API + "/taxon/194412/informations";
	
	private static final String URI_TAXON_1_PARENTS = API + "/taxon/1/parents";
	
	private static final String URI_TAXON_194412_PARENTS = API + "/taxon/194412/parents";
	
	private static final String URI_TAXON_194412_PARENTS_OR = API + "/taxon/194412/parents?limit=OR";
	
	private static final String URI_TAXON_194412_PARENTS_2 = API + "/taxon/194412/parents?limit=2";
	...
	private static final String URI_TAXON_194412_BROTHERS = API + "/taxon/194412/brothers";
	
	private static final String URI_TAXON_1_FIRST_CHILD = API + "/taxon/1/first_child_obs";
	
	private static final String URI_TAXON_194412_FIRST_CHILD = API + "/taxon/194412/first_child_obs";
	...
	private static final String URI_TAXON_2_MONOGRAPHIES = API + "/taxon/1/monographies";

	private static final String URI_TAXON_185214_MONOGRAPHIES = API + "/taxon/185214/monographies";
	...
	public void testShowGeoJson()
	{
		...
		result = route(fakeRequest(GET, URI_TAXON_194412_GEOJSON));
	...
	{
		Result result = route(fakeRequest(GET, URI_TAXON_194412_GEOJSON));
	...
	public void testShowInformations()
	{
		...
		result = route(fakeRequest(GET, URI_TAXON_194412_INFO));
		assertThat(status(result)).isEqualTo(OK);
	...
	public void testShowParents()
	{
		...
		result = route(fakeRequest(GET, URI_TAXON_194412_PARENTS));
		assertThat(status(result)).isEqualTo(OK);
		
		assertThat(contentType(result)).isEqualTo("application/json");
		
		result = route(fakeRequest(GET, URI_TAXON_194412_PARENTS_2));
		assertThat(status(result)).isEqualTo(422);
		
		result = route(fakeRequest(GET, URI_TAXON_194412_PARENTS_OR));
		assertThat(status(result)).isEqualTo(OK);
	...
	{
		Result result = route(fakeRequest(GET, URI_TAXON_194412_PARENTS));
		JsonNode json = Json.parse(contentAsString(result));
	...
	public void testShowBrothers()
	{
		...
		result = route(fakeRequest(GET, URI_TAXON_194412_BROTHERS));
		assertThat(status(result)).isEqualTo(OK);
	...
	{
		Result result = route(fakeRequest(GET, URI_TAXON_194412_BROTHERS));
		JsonNode json = Json.parse(contentAsString(result));
		assertThat(json.isArray()).isTrue();
		JsonNode first = json.get(0);
		assertThat(first.has("cdnom")).isTrue();
	...
	public void testShowFirstChildObs()
	{
	    ...
	    result = route(fakeRequest(GET, URI_TAXON_194412_FIRST_CHILD));
	    assertThat(status(result)).isEqualTo(OK);
	...
	@Test
	public void testShowMonographies()
	{
		Result result = route(fakeRequest(GET, URI_TAXON_2_MONOGRAPHIES));
		assertThat(status(result)).isEqualTo(NOT_FOUND);
		
		result = route(fakeRequest(GET, URI_TAXON_185214_MONOGRAPHIES));
		assertThat(status(result)).isEqualTo(NOT_FOUND);
